...
import {tasksReducer, removeTaskAC, addTaskAC, changeTaskStatusAC, changeTitleTaskAC} from "./state/tasks-reducer";
...
function App() {
    ...
    function changeTaskTitle(id: string, newTitle: string, todolistId: string) {
        dispatchTasks(changeTitleTaskAC(id, newTitle, todolistId))
    }
